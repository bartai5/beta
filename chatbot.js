...
const createChatLi = (message, className) => {
    ...
    let chatContent = className === "outgoing" ? `<p></p>` : `<span class="material-symbols-outlines"><img src="images/Logo.webp" alt="Image Icon Of Beta Geo Logo"></span><p></p>`;
...
const generateResponse = (incomingChatLi) =>{
    ...
    else if (userMessage.includes("services") || userMessage.includes(2) || userMessage.includes("service")){
    ...
    else if (userMessage.includes("help") || userMessage.includes(1)){
